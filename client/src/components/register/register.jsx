...
const dataBaseToggleHandler=(e)=>{
    ...
    return(
       ...
       <img src={logo} />
        <section>
            <h1>MAKE THE DAY MEMORABLE</h1>
            <section>
                <form className="registrationPageForm">
                    <section>
                        <button style={{borderRight:"1px solid gray", borderRadius:"0"}} className={vendor?"registrationPageContainerButtonColor":null} onClick={dataBaseToggleHandler}>Vendor</button>
                    ...
                    {error.userName.isValid?null:<p style={{color:"red",marginLeft:"20px",marginTop:"1px",fontSize:"12px"}}>{error.userName.message}</p>}
                    ...
                    {error.email.isValid?null:<div style={{color:"red",marginLeft:"20px",marginTop:"1px",fontSize:"12px"}}>{error.email.message}</div>}
                    ...
                    {error.phone.isValid?null:<div style={{color:"red",marginLeft:"20px",marginTop:"1px",fontSize:"12px"}}>{error.phone.message}</div>}
                    ...
                    {error.password.isValid?null:<div style={{color:"red",marginLeft:"20px",marginTop:"1px",fontSize:"12px"}}>{error.password.message}</div>}
                    <input type="password" placeholder="ConfirmPassword" onChange={functionConfirm}/>
                    {confirmPassword.isValid?null:<div style={{color:"red",marginLeft:"20px",marginTop:"1px",fontSize:"12px"}}>{confirmPassword.message}</div>}
