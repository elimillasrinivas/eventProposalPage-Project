    ...
    return(
        ...
        <section>
            ...
            <section>
                ...
                <section>
                        <button style={{borderRight:"1px solid gray",borderRadius:"0"}} className={vendor?"signinPageContainerButtonColor":null} onClick={dataBaseToggleHandler}>Vendor</button>
